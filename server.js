...
var errorController = require('./controllers/timesheet');
...
passport.use('local-signup', new LocalStrategy({
    ...
    function(req, email, password, done) {
        req.app.models.user.findOne({ email: email }, function(err, user) {
            ...
            if (user) {
                return done(null, false, { message: 'Létező email.' });
            }
...
orm.loadCollection(Waterline.Collection.extend(require('./models/timesheet')));
